...
test('collectible counts match the contract (26 vulcan, 29 obsidian, 25 nexus/helix + 44 neutral = 149)', () => {
  const byFaction = {};
  ...
  assert.equal(byFaction.obsidian, 29); // + ob_023 Counter Offer; + ob_024 Hedge Fund; + ob_025 Franchise; + ob_026 Executive Suite
  assert.equal(byFaction.neutral, 44); // + ntr_035..ntr_040, ntr_c03 Regulatory Capture, ntr_c04 War Chest
  assert.equal(collectible.length, 149);
