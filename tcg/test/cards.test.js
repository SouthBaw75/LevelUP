...
test('collectible counts match the contract (26 vulcan, 34 obsidian, 25 nexus/helix + 44 neutral = 154)', () => {
  const byFaction = {};
  ...
  assert.equal(byFaction.obsidian, 34); // + ob_023 Counter Offer; + ob_024 Hedge Fund; + ob_025 Franchise; + ob_026
  // Executive Suite; + ob_027 Mega Yacht; + ob_028 Federal Reserve Annex; + ob_029 Cayman
  // Clearinghouse; + ob_030 The Exchange; + ob_031 Talent Acquisition Center
  assert.equal(byFaction.neutral, 44); // + ntr_035..ntr_040, ntr_c03 Regulatory Capture, ntr_c04 War Chest
  assert.equal(collectible.length, 154);
